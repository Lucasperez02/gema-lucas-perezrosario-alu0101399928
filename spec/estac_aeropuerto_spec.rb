RSpec.describe GemaAparcamiento do
    ...
    describe GemaAparcamiento::EstacAeropuerto do
        before (:each) do
            ...
            @estac_tren1 = GemaAparcamiento::EstacAeropuerto.new(1, 10, 12345, "Mercadona", "Mixto", "coches", 30, 27, 2, 5, 0.5, [@veh1_1, @veh2_2],3)
        end
        ...
        it "Expectativas del to_s" do
            expect(@estac_tren1.to_s()).to eq("Aparcamiento con accesibilidad 1, seguridad 10 e id 12345. Establecimiento en Mercadona, Mixto y del tipo coches. Plazas totales 30 y 27 ocupadas.Estacionamiento a 2 km del centro de la ciudad, tiene 5 plazas para minusválidos. Precio por minuto 0.5 € y tiene 2 vehiculos. Corresponde a un estacionamiento de aeropuerto que tiene 3 plantas.")
        end        
    end
