module GemaAparcamiento
    ...
    class EstacAeropuerto < GemaAparcamiento::Datos
        ...
        def initialize(accesibilidad, seguridad, id, nombre_comercial, descripcion, tipo_aparcamiento, plazas, distancia, plazas_minusvalidos, precio_x_minuto, cjto_vehiculos, n_plantas)
